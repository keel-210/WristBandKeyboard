...
namespace sh_akira.OVRTracking
{
    public class OpenVRWrapper : IDisposable
    {
        ...
        public CVRSystem openVR { get; set; }
        ...
        public bool Setup()
        {
            ...
            if (OnOVRConnected != null) OnOVRConnected.Invoke(this, new OVRConnectedEventArgs(true));
                ...
                {//Receive VREvent
                    ...
                    switch (type)
                    {
                        case EVREventType.VREvent_Quit:
                            if (OnOVRConnected != null) OnOVRConnected.Invoke(this, new OVRConnectedEventArgs(false));
                            break;
                            //ほかにもイベントはいろいろある
                    }
